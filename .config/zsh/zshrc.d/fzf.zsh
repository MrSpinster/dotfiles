...
#█▓▒░ start fzf
[ -f "${XDG_DATA_HOME:-$HOME/.config}"/fzf/fzf.zsh ] \
     && source "${XDG_DATA_HOME:-$HOME/.config}"/fzf/fzf.zsh

#█▓▒░ Enabel fzf keybindings and completions
...
"
# Use FZF default options for Dotbare
export DOTBARE_FZF_DEFAULT_OPTS=$FZF_DEFAULT_OPTS
# Use bat for Dotbare preview
export DOTBARE_PREVIEW="bat --style=numbers --color=always {}"
